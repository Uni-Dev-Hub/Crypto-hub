...
Item {
    ...
    readonly property bool portfolioEnabled: PortfolioEngine.parsePortfolio(panelRoot.portfolioJson).enabled
    readonly property int totalTabsCount: portfolioEnabled ? 3 : 2

    onPortfolioEnabledChanged: {
        if (!portfolioEnabled && currentTabIndex === 2) {
            currentTabIndex = 0;
        }
    }
    ...
    ColumnLayout {
        ...
        // Капсульний перемикач
        Rectangle {
            id: tabCapsule
            Layout.alignment: Qt.AlignHCenter
            Layout.preferredWidth: Math.round(Kirigami.Units.gridUnit * (panelRoot.portfolioEnabled ? 15.5 : 10.5))
            ...
            Row {
                ...
                Rectangle {
                    width: tabRow.width / panelRoot.totalTabsCount
                ...
                Rectangle {
                    visible: panelRoot.portfolioEnabled
                    width: tabRow.width / panelRoot.totalTabsCount
                    height: tabRow.height
                    radius: 14
                    color: panelRoot.currentTabIndex === 2 ? Kirigami.Theme.highlightColor : "transparent"
                    ...
                    PlasmaComponents.Label {
                        ...
                        color: panelRoot.currentTabIndex === 2 ? Kirigami.Theme.highlightedTextColor : Kirigami.Theme.textColor
                        opacity: panelRoot.currentTabIndex === 2 ? 1.0 : 0.6
                    }

                    MouseArea {
                        anchors.fill: parent
                        cursorShape: Qt.PointingHandCursor
                        onClicked: panelRoot.currentTabIndex = 2
                    }
                }
            }
        }
        ...
        Item {
            ...
            Item {
                ...
                Row {
                    ...
                    width: parent.width * panelRoot.totalTabsCount
                    x: -panelRoot.currentTabIndex * parent.width
                    ...
                    FavoritesTab {
                        ...
                        portfolioJson: panelRoot.portfolioJson
                    ...
                    PortfolioTab {
                        ...
                        onConfigureRequested: panelRoot.configureRequested()
                        onToggleHideBalance: panelRoot.toggleHideBalance()
                    }
                }
            }
