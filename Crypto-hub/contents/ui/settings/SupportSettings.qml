...
Kirigami.ScrollablePage {
    ...
    ColumnLayout {
        ...
        ColumnLayout {
            ...
            Controls.Label {
                text: i18n("Crypto-hub provides real-time crypto market monitoring via 16 desktop card types, custom crypto portfolio, auto-refresh, and a local SQLite database for offline coin search. The project is fully open source under the GNU GPLv3 license.")
                wrapMode: Text.Wrap
                Layout.fillWidth: true
                font.pointSize: 9.5
                lineHeight: 1.25
            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        Controls.Label {
                            text: i18n("Changes in version v1.1.0:")
                            font.bold: true
                            font.pointSize: 10
                        }
                    }
                    ...
                    Controls.Label {
                        text: i18n("• Added full-featured Crypto Portfolio with 100% private, client-side storage.\n• Dynamic 3-tab popup slider with total balance, 24h PnL, all-time PnL, and allocation bar.\n• 16th standalone desktop widget card for Portfolio monitoring.\n• Quick balance privacy toggle (hide/show balance) across desktop and popup.\n• General performance optimizations and UI refinements.")
                        wrapMode: Text.Wrap
                        Layout.fillWidth: true
                        font.pointSize: 9
                        lineHeight: 1.3
                ...
                ColumnLayout {
                    ...
                    Rectangle {
                        ...
                        Controls.Label {
                            ...
                            anchors.fill: parent
                            anchors.margins: 10
                            text: i18n("When placing the widget directly on the desktop (desktop mode), open \"General Settings\" and choose one of the 16 card types (Coin Card, Portfolio, Fear & Greed Index, Global Market Cap, BTC Halving, ETH/BTC, Rainbow Zone, etc.).")
                            wrapMode: Text.Wrap
                            font.pointSize: 8.5
                            opacity: 0.85
                        }
