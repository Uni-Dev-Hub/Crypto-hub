...
Kirigami.ScrollablePage {
    ...
    function selectSearchResult(index) {
        if (index >= 0 && index < desktopSearchResultsModel.count) {
            ...
            if (typeof Plasmoid !== "undefined" && Plasmoid && Plasmoid.configuration) {
                Plasmoid.configuration.favoriteCoins = selected.coinId;
            }
    ...
    function resolveAndSaveCoin(inputText) {
        ...
        if (clean === "") {
            ...
            if (typeof Plasmoid !== "undefined" && Plasmoid && Plasmoid.configuration) {
                Plasmoid.configuration.favoriteCoins = "";
            }
            return;
        }
        ...
        if (typeof Plasmoid !== "undefined" && Plasmoid && Plasmoid.configuration) {
            Plasmoid.configuration.favoriteCoins = resolvedId;
        }
    }
    ...
    Kirigami.FormLayout {
            ...
            onActivated: (index) => {
                ...
                if (index >= 0 && index < m.length) {
                    ...
                    if (generalSettings.cfg_vsCurrency !== val) {
                        ...
                        if (typeof Plasmoid !== "undefined" && Plasmoid && Plasmoid.configuration) {
                            Plasmoid.configuration.vsCurrency = val;
                        }
                    }
                }
            }
            ...
            onActivated: (index) => {
                ...
                if (index >= 0 && index < m.length) {
                    ...
                    if (generalSettings.cfg_updateInterval !== val) {
                        ...
                        if (typeof Plasmoid !== "undefined" && Plasmoid && Plasmoid.configuration) {
                            Plasmoid.configuration.updateInterval = val;
                        }
                    }
                }
            }
        ...
        Controls.ComboBox {
            ...
            Connections {
                target: generalSettings
                function onCfg_desktopCardTypeChanged() {
                    cardTypeCombo.currentIndex = generalSettings.cfg_desktopCardType;
                }
            }
            ...
            onActivated: (index) => {
                if (generalSettings.cfg_desktopCardType !== index) {
                    ...
                    if (typeof Plasmoid !== "undefined" && Plasmoid && Plasmoid.configuration) {
                        Plasmoid.configuration.desktopCardType = index;
                    }
                }
            }
        }
            ...
            onTextChanged: {
                if (desktopCoinInput.activeFocus && !generalSettings.isProgrammaticChange) {
                    ...
                    if (generalSettings.cfg_favoriteCoins !== clean) {
                        ...
                        if (typeof Plasmoid !== "undefined" && Plasmoid && Plasmoid.configuration) {
                            Plasmoid.configuration.favoriteCoins = clean;
                        }
                    }
                    generalSettings.activeSearchIndex = -1;
        ...
        Controls.CheckBox {
            ...
            onToggled: {
                generalSettings.cfg_showTicker = checked;
                if (typeof Plasmoid !== "undefined" && Plasmoid && Plasmoid.configuration) {
                    Plasmoid.configuration.showTicker = checked;
                }
            }
        }
        ...
        Controls.CheckBox {
            ...
            onToggled: {
                generalSettings.cfg_showSummary = checked;
                if (typeof Plasmoid !== "undefined" && Plasmoid && Plasmoid.configuration) {
                    Plasmoid.configuration.showSummary = checked;
                }
            }
        }
        ...
        Controls.CheckBox {
            ...
            onToggled: {
                generalSettings.cfg_showMiniCards = checked;
                if (typeof Plasmoid !== "undefined" && Plasmoid && Plasmoid.configuration) {
                    Plasmoid.configuration.showMiniCards = checked;
                }
            }
        }
        ...
        Controls.CheckBox {
            ...
            onToggled: {
                generalSettings.cfg_showAnalysisCards = checked;
                if (typeof Plasmoid !== "undefined" && Plasmoid && Plasmoid.configuration) {
                    Plasmoid.configuration.showAnalysisCards = checked;
                }
            }
        }
        ...
        Controls.CheckBox {
            ...
            onToggled: {
                generalSettings.cfg_showTables = checked;
                if (typeof Plasmoid !== "undefined" && Plasmoid && Plasmoid.configuration) {
                    Plasmoid.configuration.showTables = checked;
                }
            }
        }
        ...
        Controls.CheckBox {
            ...
            onToggled: {
                generalSettings.cfg_showHalving = checked;
                if (typeof Plasmoid !== "undefined" && Plasmoid && Plasmoid.configuration) {
                    Plasmoid.configuration.showHalving = checked;
                }
            }
        }
    }
